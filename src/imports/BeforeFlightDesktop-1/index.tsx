...
function Wrapper() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center relative shrink-0 w-full" data-name="wrapper">
...
function Wrapper1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start leading-[normal] max-w-[500px] relative shrink-0 text-center w-full" data-name="wrapper">
...
function Wrapper2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center justify-center max-w-[600px] relative shrink-0 w-[400px]" data-name="wrapper">
