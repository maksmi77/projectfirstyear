function Wrapper() {
  return (
    <div className="content-stretch flex flex-col font-['Cormorant_Garamond:Regular',sans-serif] items-center py-[100px] relative shrink-0 w-full" data-name="wrapper">
      <p className="relative shrink-0 text-[500px] whitespace-nowrap">404</p>
      <p className="min-w-full relative shrink-0 text-[100px] w-[min-content]">Flight not found</p>
    </div>
  );
}

export default function Component404Desktop() {
  return (
    <div className="[word-break:break-word] bg-white content-stretch flex flex-col font-normal items-start leading-[normal] relative size-full text-[#000b1c] text-center" data-name="404-Desktop">
      <Wrapper />
